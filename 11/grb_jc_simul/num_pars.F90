module Numerical_Parameters
  ...
  !
  real*8 RDISK_HALF_SCALE,EM_RDISK_HALF_SCALE_O2
  ...
  real*8 PI,PIO4,PI4,PIO2,PISQ,SQRT2PI,SQRT2OPI,SQRTPI,logPI
  ...
  real*8 SQRT2,LN2,LN10,ISO_FAC,log4
  ...
  ! Quantities, page 12)
  !
  real*8 MSOLAR,sqrtMSOLAR,MSOLAR_1030kg
  ...
  !   Book 2002, page 5)
  real*8 k_Boltzmann,logk_Boltzmann,sqrtk_Boltzmann,k_Boltzmann_erg
  ...
  !   page 8)
  real*8 c_light_Angstroms,logc_light_Angstroms
  ...
  !	integer Z_Atomic
  !	real*8 Atomic_Mass(2)
  !	data (Atomic_Mass(Z_Atomic),Z_Atomic=1,2) /1.00794,4.002602/
  real*8 Atomic_Mass_Hydrogen,Atomic_Mass_Helium,sqrtAtomic_Mass_Hydrogen
  ...
  real*8 AB_NORM,L_AB0,logL_AB0,AB_MAG_NORM
...
module Atomic_Data
  ...
  !
  ! Floats
  real*8 E_Halpha,E_Hbeta,E_Hydrogen_n1,N_Halpha_N_Lyc,N_Hbeta_N_Lyc,wH,wHeI,wHeII
  real*8 logE_Hydrogen_n1,logE_Halpha,logE_Hbeta,logN_Halpha_N_Lyc,logN_Hbeta_N_Lyc
  !     
  ! Parameters
